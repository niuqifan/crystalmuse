...
const products = [
  ...
  {id:4,name:'Black Obsidian Bracelet',intention:'Protection',chakra:'Root',zodiac:'Scorpio',crystal:'Obsidian',shape:'Bracelet
  ',moq:50,icon:'●',grad:'linear-gradient(135deg,#3a3040,#050505)',desc:'A grounding protection bracelet for shielding negative energy.'},
