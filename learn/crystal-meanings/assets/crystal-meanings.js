const crystals = [
  {name:'Amethyst',letter:'A',meaning:'Traditionally associated with calm, intuition, spiritual awareness, and reflective energy.',best:'Calm, reflection, intuition',chakra:'third eye,crown',zodiac:'Pisces, Aquarius',intention:'calm focus',color:'linear-gradient(120deg,#8d5bb5,#ede0f6,#5b2d78)'},
  ...
  {name:'Green Aventurine',letter:'G',meaning:'Traditionally associated with luck, growth, compassion, and gentle opportunity.',best:'Abundance, compassion',chakra:'heart',zodiac:'Taurus, Virgo',intention:'abundance love',color:'linear-gradient(120deg,#3f9d6d,#dbf4df,#246443)'},
  ...
  {name:'Howlite',letter:'H',meaning:'Traditionally associated with patience, quiet reflection, and a peaceful atmosphere.',best:'Calm, patience',chakra:'crown',zodiac:'Gemini, Virgo',intention:'calm',color:'linear-gradient(120deg,#efefea,#ffffff,#c8c2bc)'},
  ...
  {name:'Malachite',letter:'M',meaning:'Traditionally associated with transformation, courage, compassion, and emotional growth.',best:'Change, courage',chakra:'heart',zodiac:'Scorpio, Capricorn',intention:'love protection',color:'linear-gradient(120deg,#0b6d4c,#69c18b,#02482e)'},
  ...
  {name:'Rhodonite',letter:'R',meaning:'Traditionally associated with compassion, forgiveness, resilience, and heart-centered confidence.',best:'Love, compassion',chakra:'heart',zodiac:'Taurus, Leo',intention:'love calm',color:'linear-gradient(120deg,#bc5d82,#f1c4d1,#4a2b35)'},
  ...
  {name:'Smoky Quartz',letter:'S',meaning:'Traditionally associated with grounding, release, protection, and steady resilience.',best:'Grounding, reflection',chakra:'root',zodiac:'Capricorn, Sagittarius',intention:'protection calm',color:'linear-gradient(120deg,#5d5048,#c9b7a6,#2e2928)'},
...
function cardTemplate(crystal){
  ...
  return `<article class="ag-card" data-search="${[crystal.name,crystal.meaning,crystal.best,crystal.chakra,crystal.zodiac,crystal.intention].join(' ').toLowerCase()}" data-letter="${crystal.letter}" data-chakra="${crystal.chakra}" data-intention="${crystal.intention}">
    ...
    <div class="ag-card-body">
      ...
      <div class="ag-meta">
        <div class="ag-meta-row"><span>Intentions</span><span>${crystal.best}</span></div>
